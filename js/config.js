...
const SITE = {
  ...
  /* ---- 학사 · 학과 링크의 인문대학 목록 ----
     전공이 있는 학부는 children 을 두면 학부를 눌러 펼칠 수 있다.
     학과는 url 을 두면 바로 홈페이지로 이동한다.
     신청 폼의 학과 선택지인 departments 와는 용도가 다르다. */
  majors: [
    { name: '국어국문학부', children: [
      { name: '국어국문학전공', url: 'https://koll.cau.ac.kr/' },
      { name: '한국어교육・한국문화전공', url: 'https://keducation-kculture.github.io/homepage_tem/' }
    ] },
    { name: '영어영문학과', url: 'http://english.cau.ac.kr/' },
    { name: '유럽문화학부', children: [
